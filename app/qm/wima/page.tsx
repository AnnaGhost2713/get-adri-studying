...
export default function WiMaSeite() {
  const { addXP, sitzungAbgeschlossen, wimaFortschritt } = useUser();
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-800">Wirtschaftsmathematik</h1>
        </div>
      </div>
      ...
      <div className="rounded-xl bg-emerald-50 border border-emerald-100 p-4 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right shrink-0">
            <p className="text-2xl font-bold text-emerald-700">{wimaFortschritt.sitzungenAktuell}</p>
